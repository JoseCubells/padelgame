...
namespace Padel.Simulation.Match
{
    ...
    public sealed class MatchConfig
    {
        ...
        /// <summary>Seconds a stroke request stays alive waiting for the ball [P] (input buffer, ADR-007).</summary>
        public float StrokeBuffer { get; } = 0.12f;
        ...
        public float RallyTimeout { get; } = 45f;
